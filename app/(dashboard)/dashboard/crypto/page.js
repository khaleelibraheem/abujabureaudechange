...
import { Coins, Bell, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <Coins className="w-10 h-10 text-indigo-600 dark:text-indigo-400" />
        </motion.div>
        ...
        >
          We&apos;re working on bringing you a seamless crypto exchange experience.
